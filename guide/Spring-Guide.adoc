...
include::templates/what-will-learn.adoc[]

include::templates/what-is-hz.adoc[]
...
include::templates/prereq.adoc[]

include::templates/getting-started.adoc[]
...
include::templates/start-cluster.adoc[]

include::templates/validate-kube-env.adoc[]
...
include::templates/minikube-teardown.adoc[]

include::templates/youre-done.adoc[]